% Main FOSWEC postprocessing script
...
if(~isempty(app))
    output.reference.aftAmplitude = app.AftAmplitudeSpinner.Value;
    output.reference.bowAmplitude = app.BowAmplitudeSpinner.Value;
