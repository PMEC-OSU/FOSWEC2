...
plot(output.time,squeeze(output.motor.aftRotVel_radpers))
...
plot(output.time,squeeze(output.motor.bowRotVel_radpers))
ylim([-20 20])
ylabel('\omega(rad/sec)')
xlabel('time(s)')
title('Bow')
...
figure
subplot(211)
plot(output.time,output.flap.aftFx)
hold on
plot(output.time,output.flap.aftFy)
plot(output.time,output.flap.aftFz)
...
subplot(212)
plot(output.time,output.flap.aftTx)
hold on
plot(output.time,output.flap.aftTy)
plot(output.time,output.flap.aftTz)

ylabel('\tau(Nm)')
title('Aft')
legend('\taux','\tauy','\tauz')
grid on
sgtitle('Aft load cell forces and torques')
